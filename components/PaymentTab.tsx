  ...
  return (
    <View className={cn('flex-1', paddingContainer)}>
      <MotiView
        ...
        className="mt-5">
        <View className="h-14 flex-row rounded-full bg-[#2B3034]">
          <TouchableOpacity
            style={{
              backgroundColor:
                layout === 'first' ? getProductColorByType(prodType) : '#',
              margin: 0,
              flex: 1,
              borderRadius: 23,
            }}
            ...
            <Text
              ...
              style={{
                color:
                  layout === 'first'
                    ? getProductTextColorByType(prodType)
                    : '#909198',
              }}>
              {text1}
            </Text>
          ...
          <TouchableOpacity
            style={{
              backgroundColor:
                layout === 'second' ? getProductColorByType(prodType) : '#',
              margin: 0,
              flex: 1,
              borderRadius: 23,
            }}
